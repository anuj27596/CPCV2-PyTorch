...
do
	echo "--------------------------------- Iteration $i ---------------------------------"
	python train_classifier.py --dataset breastmnist --model_name_ext breastmnist --epochs 10 --crop 24-0 --encoder resnet18 --norm layer --grid_size 5 --pred_directions 4 --cpc_patch_aug --gray --model_num 10
	python train_classifier.py --dataset breastmnist --model_name_ext breastmnist --epochs 10 --crop 24-0 --encoder resnet18 --norm layer --grid_size 5 --pred_directions 4 --cpc_patch_aug --gray --model_num 10 --fully_supervised
done
